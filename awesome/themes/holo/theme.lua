...
theme.border_focus                              = "#5CCC00"
theme.taglist_fg_focus                          = "#FFFFFF"
theme.tasklist_bg_normal                        = "#222222"
theme.tasklist_fg_focus                         = "#9EDC4C"
    ...
    s.mywibox:setup {
        ...
        },
        {
            ...
            layout = wibox.container.place,
            {
                ...
                clockwidget,
                weather_widget({
                    api_key='daeb950ae4df37bd4d4c169cf4365c94',
                    coordinates = {50.82320815951002, -0.13625025980249794},
                    time_format_12h = false,
                    units = 'metric',
                    both_units_widget = false1,
